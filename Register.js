                ...
                <section>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <p id="pwdnote" className={pwdFocus && !validPwd ? "instruction" : "offscreen"}>
                            ...
                            Must include upper case and lowercase letters, a number and a special character.<br />
                            Allowed special character: <span arial-label="exclamation mark">!</span>
                            <span aria-label="at sybol">@</span><span aria-label="hashtag">#</span>
                            <span aria-label="dollar sign">$</span><span aria-label="percent">%</span>
                        </p>

                        <label hmlfor="confirm_pwd">
                            Confirm Password:
